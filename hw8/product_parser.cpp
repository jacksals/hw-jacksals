...
{
    set<string> keywords;
    Book* b = new Book (prodName_, price_, qty_, isbn_, author_, keywords);
    return b;
}
...
{
    set<string> keywords;
    Clothing* c = new Clothing (prodName_, price_, qty_, size_, brand_, keywords);
    return c;
}
...
{
    Product* m = new Movie (prodName_, price_, qty_, rating_, genre_);
    return m;
}
