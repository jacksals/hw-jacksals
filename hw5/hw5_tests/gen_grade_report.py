...
RUBRIC_COMPARATORS = os.path.join(source_dir, 'rubric', 'comparators.config')
...
P1 = cs_grading.Problem(HOMEWORK, 1, 'comparators', 7)
P2 = cs_grading.Problem(HOMEWORK, 2, 'msort', 15)
P3 = cs_grading.Problem(HOMEWORK, 3, 'amazon', 55)

for problem, rubric in [(P1, RUBRIC_COMPARATORS), (P2, RUBRIC_MSORT), (P3, RUBRIC_AMAZON)]:
