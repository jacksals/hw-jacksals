...
void AVLTree<Key, Value>::changebalances(AVLNode<Key,Value>* item)
{
    ...
    else
    {
        ...
        std::cout << "balance of " << item->getParent()->getValue() << " :"<< (int)item->getParent()->getBalance() << std::endl;
        int b;
        while(curr->getParent() != NULL)
        {
            ...
            std::cout << "new balance of " << curr->getParent()->getValue() << " is "<< (int)item->getParent()->getBalance() << std::endl;
            curr = curr->getParent();
        }
